...
import {
  ...
  CommandItem,
  CommandList,
} from "@/registries/extend/ui/command"
import {
  Dialog,
  DialogClose,
  DialogContent,
...
import { ScrollArea, ScrollAreaPrimitive } from "@/registries/extend/ui/scroll-area"
import {
  Select,
  SelectContent,
  SelectItem,
...
import { Tabs, TabsList, TabsTrigger } from "@/registries/extend/ui/tabs"
import { FileThumbnail } from "@/registries/extend/extend/file-thumbnail"
import { ChevronDown, ChevronUp, Calendar, FileArchiveIcon, GalleryThumbnails, LayoutGrid, Columns3, Columns3Icon, ChevronLeft, ArrowRight, X, Search, ArrowUpDown, Check, Filter } from "lucide-react"
...
const LazyPDFViewer = React.lazy(() =>
  import("@/registries/extend/extend/pdf-viewer").then((mod) => ({
    default: mod.PDFViewer,
  }))
)
const LazyDocxViewerPreview = React.lazy(() =>
  import("@/registries/extend/extend/docx-viewer").then((mod) => ({
    default: mod.DocxViewerPreview,
  }))
)
const LazyPptxViewerPreview = React.lazy(() =>
  import("@/registries/extend/extend/pptx-viewer").then((mod) => ({
    default: mod.PptxViewerPreview,
  }))
)
const LazyXlsxViewerPreview = React.lazy(() =>
  import("@/registries/extend/extend/xlsx-viewer").then((mod) => ({
