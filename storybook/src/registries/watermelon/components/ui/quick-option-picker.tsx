    ...
    >
      ...
      >
                ...
                {data.map((option, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`relative flex items-center gap-2 px-5 py-3 text-[15px] font-semibold transition-all duration-300 ${roundedClasses} bg-[#FEFEFE] dark:bg-neutral-700 ${
                        isActive
                          ? "text-[#010101] dark:text-white"
                          : "text-[#6E6E6E] dark:text-neutral-400"
                      }`}
                    >
                      <motion.span>
                        <option.icon size={22} />
        ...
        <motion.button
          ...
          className={`flex items-center justify-center gap-2 rounded-full border border-transparent px-4 py-4 transition-all duration-300 select-none ${
            isOpen
              ? "bg-[#E5E5E5] dark:border-neutral-700 dark:bg-neutral-800"
            ...
            >
              <selected.icon
                ...
                className={`transition-colors duration-300 ${
                  isOpen
                    ? "text-[#AEAEAE] dark:text-neutral-500"
                    : "text-[#AFAFAF] dark:text-neutral-400"
                }`}
              />
            </motion.div>
          </AnimatePresence>
